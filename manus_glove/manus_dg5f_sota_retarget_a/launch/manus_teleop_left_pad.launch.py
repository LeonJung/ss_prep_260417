"""End-to-end left-hand teleop — PAD / lateral grip mode.

Mirror of manus_teleop_right_pad.launch.py for the left hand.
"""
...
def generate_launch_description():
    ...
    cfg_yaml = PathJoinSubstitution([
        FindPackageShare("manus_dg5f_sota_retarget_a"), "config", "left_hand_pad.yaml"
    ])
